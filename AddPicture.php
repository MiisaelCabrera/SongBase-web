<?php 
    ...
    if($username != "")
    {
        ...
        if((strpos($img_type, "gif") || strpos($img_type, "jpeg") || strpos($img_type, "jpg")) || strpos($img_type, "png"))
        {
            ...
            $detectedError = $cad -> addPostImage($destiny, $tmp_name, $description);
        }
       ...
       <div class="Page" lang="es">
            ...
            <div class="Content" id="ProfilePicture">
                <div class="square">
                    ...
                    <div class="Subtitle">Subir una foto</div>
                    <form class="ProfilePictureForm" action="AddPicture.php" name="ProfilePicture" method="POST" enctype="multipart/form-data">
