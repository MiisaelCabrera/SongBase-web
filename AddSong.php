<?php 
    ...
    if($username != "")
    {
        ...
        if(isset($name) && isset($instrument) && isset($scale) && isset($type) && $txt_type = "text/plain")
        {
            ...
            $cad->addPostSong($name, $instrument, $scale, $type, $imgId, $txtdestiny, $file_tmp_name, $description);
       ...
       <div class="Page" lang="es">
            ...
            <div class="Content" id="AddSong">
                <div class="square">
                    ...
                    <form class="ProfilePictureForm" action="AddSong.php" name="ProfilePicture" method="POST" enctype="multipart/form-data">
